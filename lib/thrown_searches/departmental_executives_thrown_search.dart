...
Color modalColor = Color.fromRGBO(143, 189, 211, 1);
...
class MyDepartmentalExecutivesSearch extends SearchDelegate {
  final List all;

  MyDepartmentalExecutivesSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((departmentalExecutives) => departmentalExecutives.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((departmentalExecutives) => departmentalExecutives.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          departmentalExecutivesNotifier.currentDepartmentalExecutives = search[position];
