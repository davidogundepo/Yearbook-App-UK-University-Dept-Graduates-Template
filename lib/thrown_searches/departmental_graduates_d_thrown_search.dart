...
class MyDepartmentalGraduatesSearchD extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyDepartmentalGraduatesSearchD({@required this.all});
  ...
  Future navigateToDepartmentalGraduatesSearchDDetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((departmentalGraduatesSearchD) => departmentalGraduatesSearchD.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((departmentalGraduatesSearchD) => departmentalGraduatesSearchD.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          departmentalGraduatesDNotifier.currentDepartmentalGraduatesD = search[position];
                           navigateToDepartmentalGraduatesSearchDDetailsPage(context);
                        },
