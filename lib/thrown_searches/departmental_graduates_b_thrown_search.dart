...
Color modalColor = Color.fromRGBO(141, 141, 170, 1);
...
class MyDepartmentalGraduatesSearchB extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyDepartmentalGraduatesSearchB({@required this.all});
  ...
  Future navigateToDepartmentalGraduatesSearchBDetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((departmentalGraduatesSearchB) => departmentalGraduatesSearchB.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((departmentalGraduatesSearchB) => departmentalGraduatesSearchB.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          departmentalGraduatesBNotifier.currentDepartmentalGraduatesB = search[position];
                          navigateToDepartmentalGraduatesSearchBDetailsPage(context);
                        },
