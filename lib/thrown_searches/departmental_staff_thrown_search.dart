...
class MyDepartmentalStaffSearch extends SearchDelegate {
  final List all;

  MyDepartmentalStaffSearch({@required this.all});
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((departmentalStaff) => departmentalStaff.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((departmentalStaff) => departmentalStaff.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          departmentalStaffNotifier.currentDepartmentalStaff = search[position];
