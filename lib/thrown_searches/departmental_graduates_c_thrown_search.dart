...
class MyDepartmentalGraduatesSearchC extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyDepartmentalGraduatesSearchC({@required this.all});
  ...
  Future navigateToDepartmentalGraduatesSearchCDetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((departmentalGraduatesSearchC) => departmentalGraduatesSearchC.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((departmentalGraduatesSearchC) => departmentalGraduatesSearchC.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          departmentalGraduatesCNotifier.currentDepartmentalGraduatesC = search[position];
                          navigateToDepartmentalGraduatesSearchCDetailsPage(context);
                        },
