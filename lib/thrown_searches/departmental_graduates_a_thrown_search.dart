...
Color modalColor = Color.fromRGBO(38, 135, 179, 1.0);
...
Color dialogBackgroundColor = Color.fromRGBO(38, 135, 179, 1.0);
Color borderColor = Colors.black;
Color textHighlightColor = Colors.white;

var queryTech;

class MyDepartmentalGraduatesSearchA extends SearchDelegate {
  final List all;

  bool _isVisible = true;

  MyDepartmentalGraduatesSearchA({@required this.all});
  ...
  Future navigateToDepartmentalGraduatesSearchADetailsPage(context) async {
  ...
  Widget buildResults(BuildContext context) {
    ...
    var search = all.where((departmentalGraduatesSearchA) => departmentalGraduatesSearchA.name.contains(query2)).toList();
  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    if(queryTech.isNotEmpty){
      search =all.where((departmentalGraduatesSearchA) => departmentalGraduatesSearchA.name.contains(queryTech)).toList();
                  ...
                  child: Container(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          departmentalGraduatesANotifier.currentDepartmentalGraduatesA = search[position];
                          navigateToDepartmentalGraduatesSearchADetailsPage(context);
                        },
