...
String favoriteSportOnCampusTitle = "Favourite Sport Activity on Campus\n";
...
String collegeTitle = "College Name\n";
String collegeGraduationYearTitle = "College Graduation Year\n";
...
Color backgroundColor = Color.fromRGBO(141, 141, 170, 1);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(141, 141, 170, 1);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(141, 141, 170, 1);
Color shapeDecorationTextColor = Color.fromRGBO(141, 141, 170, 1);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor = Color.fromRGBO(141, 141, 170, 1);
Color splashColor = Color.fromRGBO(141, 141, 170, 1);
Color splashColorTwo = Colors.white;
Color iconTextColor = Color.fromRGBO(141, 141, 170, 1);
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(141, 141, 170, 1);
Color textColor = Color.fromRGBO(141, 141, 170, 1);
...
DepartmentalGraduatesBNotifier departmentalGraduatesBNotifier;

Map<int, Widget> userBIO;

var _highSchool;
var _college;
var _collegeGraduationYear;
var _autoBio;
var _bestMoment;
...
class MyDepartmentalGraduatesDetailsPageB extends StatefulWidget {
  @override
  _MyDepartmentalGraduatesDetailsPageBState createState() => _MyDepartmentalGraduatesDetailsPageBState();
}

class _MyDepartmentalGraduatesDetailsPageBState extends State<MyDepartmentalGraduatesDetailsPageB> {
  ...
  Widget build(BuildContext context) {
    departmentalGraduatesBNotifier = Provider.of<DepartmentalGraduatesBNotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.image,
                        fit: BoxFit.cover,
                  ...
                  message: departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.name.toUpperCase(),
                            ...
                            (() {
                              if (departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.departmentExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    _autoBio = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.autoBio;
    _bestMoment = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.bestMoment;
    _whyCourseOfStudy = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.whyCourseOfStudy;
    _highSchool = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.highSchool;
    _college = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.college;
    _highSchoolGraduationYear = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.highSchoolGraduationYear;
    _collegeGraduationYear = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.collegeGraduationYear;
    _linkedIn = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.linkedIn;
    _favouriteCourse = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.favouriteCourse;
    _departmentExecutive = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.departmentExecutive;
    _departmentExecutivePosition = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.departmentExecutivePosition;
    _favouriteLocationOnCampus = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.favouriteLocationOnCampus;
    _favoriteSportOnCampus = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.favoriteSportOnCampus;
    _country = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.constituentCountry;
    _regionFrom = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.regionFrom;
    _favSchoolActivity = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.favoriteSchoolActivity;
    _whatsNext = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.whatsNext;
    _bestMoment = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.bestMoment;
    _dob = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.dob;
    _email = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.email;
    _facebook = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.facebook;
    _hobbies = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.hobbies;
    _instagram = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.instagram;
    _myDropline = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.myDropline;
    _name = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.name;
    _nickname = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.nickname;
    _philosophy = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.philosophy;
    _phone = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.phone;
    _twitter = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.twitter;
    _worstMoment = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.worstMoment;
    _occupation = departmentalGraduatesBNotifier.currentDepartmentalGraduatesB.occupation;
    ...
    userBIO = <int, Widget>{
                ...
                return Padding(
                  ...
                  child: InkWell(
                    ...
                    child: RaisedButton.icon(
                      ...
                      elevation: 2,
                      color: buttonColor,
                      icon: new Icon(MdiIcons.twitter, color: iconTextColorTwo),
      ...
      1: Column(
        ...
        children: <Widget>[
          ...
          (() {
            if (_college.toString().isNotEmpty) {
              return Padding(
                padding: const EdgeInsets.only(top: 20.0),
                child: Container(
                  child: Material(
          ...
          (() {
            if (_collegeGraduationYear.toString().isNotEmpty) {
              return Padding(
                padding: const EdgeInsets.only(top: 20.0),
                child: Container(
                  child: Material(
                      ...
                      child: Padding(
                        ...
                        child: Text.rich(
                          TextSpan(
                            children: <TextSpan>[
                              TextSpan(
                                  text: collegeGraduationYearTitle,
                                  style:  GoogleFonts.aBeeZee(
                                    color: textColor,
                                    fontSize: 19,
                                    fontWeight: FontWeight.bold,
