...
String positionEnforcingTitle = "Staff Position\n";
...
String courseTeachingTitle = "Course(s) Teaching\n";
...
Color shapeDecorationColor = Color.fromRGBO(52, 76, 183, 1);
Color shapeDecorationTextColor = Color.fromRGBO(52, 76, 183, 1);
Color shapeDecorationIconColor = Color.fromRGBO(52, 76, 183, 1);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor = Color.fromRGBO(52, 76, 183, 1);
Color splashColor = Color.fromRGBO(52, 76, 183, 1);
Color splashColorTwo = Colors.white;
Color iconTextColor = Colors.white;
Color buttonColor = Color.fromRGBO(52, 76, 183, 1);
Color textColor = Color.fromRGBO(52, 76, 183, 1);
...
DepartmentalStaffNotifier departmentalStaffNotifier;
...
class MyDepartmentalStaffDetailsPage extends StatefulWidget {

  @override
  _MyDepartmentalStaffDetailsPageState createState() => _MyDepartmentalStaffDetailsPageState();
}

class _MyDepartmentalStaffDetailsPageState extends State<MyDepartmentalStaffDetailsPage> {
  ...
  Widget build(BuildContext context) {
    departmentalStaffNotifier = Provider.of<DepartmentalStaffNotifier>(context, listen: true);
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: departmentalStaffNotifier.currentDepartmentalStaff.image,
                        fit: BoxFit.cover,
                  ...
                  message: departmentalStaffNotifier.currentDepartmentalStaff.name),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(
                              departmentalStaffNotifier.currentDepartmentalStaff.name.toUpperCase(),
  ...
  initState() {
    ...
    DepartmentalStaffNotifier departmentalStaffNotifier =
    Provider.of<DepartmentalStaffNotifier>(context, listen: false);

    _autoBio = departmentalStaffNotifier.currentDepartmentalStaff.autoBio;
    _regionFrom = departmentalStaffNotifier.currentDepartmentalStaff.regionOfOrigin;
    _academicQualification = departmentalStaffNotifier.currentDepartmentalStaff.qualification;
    _email = departmentalStaffNotifier.currentDepartmentalStaff.email;
    _facebook = departmentalStaffNotifier.currentDepartmentalStaff.facebook;
    _hobbies = departmentalStaffNotifier.currentDepartmentalStaff.hobbies;
    _inceptionYear = departmentalStaffNotifier.currentDepartmentalStaff.yearOfInception;
    _name = departmentalStaffNotifier.currentDepartmentalStaff.name;
    _philosophy = departmentalStaffNotifier.currentDepartmentalStaff.philosophy;
    _phone = departmentalStaffNotifier.currentDepartmentalStaff.phone;
    _twitter = departmentalStaffNotifier.currentDepartmentalStaff.twitter;
    _instagram = departmentalStaffNotifier.currentDepartmentalStaff.instagram;
    _linkedIn = departmentalStaffNotifier.currentDepartmentalStaff.linkedIn;
    _courseTeaching = departmentalStaffNotifier.currentDepartmentalStaff.courseTeaching;
    _positionEnforcing = departmentalStaffNotifier.currentDepartmentalStaff.staffPosition;
