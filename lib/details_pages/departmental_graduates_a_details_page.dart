...
Color backgroundColor = Color.fromRGBO(38, 135, 179, 1.0);
Color appBarTextColor = Colors.white;
Color appBarBackgroundColor = Color.fromRGBO(38, 135, 179, 1.0);
Color appBarIconColor = Colors.white;
Color materialBackgroundColor = Colors.transparent;
Color shapeDecorationColor = Color.fromRGBO(38, 135, 179, 1.0);
Color shapeDecorationTextColor = Color.fromRGBO(38, 135, 179, 1.0);
Color shapeDecorationIconColor = Color.fromRGBO(38, 135, 179, 1.0);
Color cardBackgroundColor = Colors.white;
Color cardThumbColor = Colors.white;
Color cardThumbBackgroundColor = Color.fromRGBO(38, 135, 179, 1.0);
Color splashColor = Color.fromRGBO(38, 135, 179, 1.0);
Color splashColorTwo = Colors.white;
Color iconTextColor = Color.fromRGBO(38, 135, 179, 1.0);
Color iconTextColorTwo = Colors.white;
Color buttonColor = Color.fromRGBO(38, 135, 179, 1.0);
Color textColor = Color.fromRGBO(38, 135, 179, 1.0);
...
DepartmentalGraduatesANotifier departmentalGraduatesANotifier;
...
class MyDepartmentalGraduatesDetailsPageA extends StatefulWidget {
  @override
  _MyDepartmentalGraduatesDetailsPageAState createState() => _MyDepartmentalGraduatesDetailsPageAState();
}

class _MyDepartmentalGraduatesDetailsPageAState extends State<MyDepartmentalGraduatesDetailsPageA> {
  ...
  Widget build(BuildContext context) {
    ...
    departmentalGraduatesANotifier = Provider.of<DepartmentalGraduatesANotifier>(context, listen: true);
    ...
    return ConfettiWidget(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          centerTitle: true,
          title: Text(departmentalGraduatesANotifier.currentDepartmentalGraduatesA.nickname,
          ...
          child: Column(
            ...
            children: <Widget>[
              Tooltip(
                  child: Container(
                    ...
                    child: Card(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: departmentalGraduatesANotifier.currentDepartmentalGraduatesA.image,
                        fit: BoxFit.cover,
                  ...
                  message: departmentalGraduatesANotifier.currentDepartmentalGraduatesA.name
              ),
              Material(
                    ...
                    child: Padding(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text(departmentalGraduatesANotifier.currentDepartmentalGraduatesA.name.toUpperCase(),
                            ...
                            (() {
                              if (departmentalGraduatesANotifier.currentDepartmentalGraduatesA.departmentExecutive == "Yes") {
                                return
                                  Row(
                                    children: <Widget>[
                                      SizedBox(width: 10),
  ...
  initState(){
    ...
    _autoBio = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.autoBio;
    _bestMoment = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.bestMoment;
    _whyCourseOfStudy = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.whyCourseOfStudy;
    _highSchool = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.highSchool;
    _college = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.college;
    _highSchoolGraduationYear = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.highSchoolGraduationYear;
    _collegeGraduationYear = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.collegeGraduationYear;
    _linkedIn = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.linkedIn;
    _favouriteCourse = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.favouriteCourse;
    _departmentExecutive = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.departmentExecutive;
    _departmentExecutivePosition = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.departmentExecutivePosition;
    ...
    _country = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.constituentCountry;
    _regionFrom = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.regionFrom;
    _favSchoolActivity = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.favoriteSchoolActivity;
    _whatsNext = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.whatsNext;
    _bestMoment = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.bestMoment;
    _dob = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.dob;
    _email = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.email;
    _facebook = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.facebook;
    _hobbies = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.hobbies;
    _instagram = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.instagram;
    _myDropline = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.myDropline;
    _name = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.name;
    _nickname = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.nickname;
    _philosophy = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.philosophy;
    _phone = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.phone;
    _twitter = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.twitter;
    _worstMoment = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.worstMoment;
    _occupation = departmentalGraduatesANotifier.currentDepartmentalGraduatesA.occupation;
